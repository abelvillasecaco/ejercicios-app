...
// 2. Declara una variable de tipo float llamada precio y asígnale el
// valor 17.99.
// 3. Declara una variable de tipo char llamada genero y asígnale la letra ‘F’.
// 4. Declara una variable de tipo double llamada distancia y asígnale el valor
// 12345.6789
// 5. Declara una variable de tipo bool llamada esGraduado y asígnale false.
// 6. Crea un programa que multiplique una variable float por una variable
// double y muestra el resultado.
// 7. Crea un programa que cambien el valor de una variable bool y muestra el
// nuevo valor.
...
// 10. Intenta asignar un valor fuera del rango permitido para una variable int
...
int main() {
  ...
  if (enteroUno > enteroDos) {
    cout << "9. En numero mayor es: " << enteroUno << endl;
  } else if (enteroDos > enteroUno) {
    cout << "9. El numero mayor es: " << enteroDos << endl;
  } else {
    cout << "9. Los números son iguales" << endl;
  }
  // Ejercicio 10
  int noSeasMalo = 2147483647 + 1;
  // Al compilar se muestra un warning en consola:  integer overflow
  cout << "10. Entero desbordado: " << noSeasMalo << endl;
